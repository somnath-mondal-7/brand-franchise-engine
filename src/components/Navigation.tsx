      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="lg:hidden">
            <Button variant="outline" size="sm" onClick={toggleMenu} aria-label={isMenuOpen ? "Close menu" : "Open menu"} aria-expanded={isMenuOpen} className="text-foreground border-border bg-background min-h-[44px] min-w-[44px]">
